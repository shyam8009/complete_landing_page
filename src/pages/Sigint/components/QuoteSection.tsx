  ...
  return (
    <section className="section-padding bg-black border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 lg:px-6 relative z-10 text-center">
        <h2 className="quote-text text-3xl sm:text-4xl md:text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-12 leading-tight tracking-tight" style={{ fontFamily: INTER }}>
          "Unparalleled situational foresight through invisible spectrum exploitation."
        </h2>
        
        <div className="quote-text flex flex-col items-center gap-6">
          <TechCTA>
            CONTACT INTELLIGENCE SYSTEMS DIVISION
          </TechCTA>
        </div>
      </div>
    </section>
