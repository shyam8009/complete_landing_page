...
import imgComint from '@/imports/sigint/comint_operations.png';
import imgElint from '@/imports/sigint/elint_operations.png';
import imgDf from '@/imports/sigint/precision_direction_finding.jpg';
