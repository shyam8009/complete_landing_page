...
export function ClienteleCTA({ onContactClick }: { onContactClick?: () => void }) {
  return (
    <section className="section-padding bg-black relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(132,204,22,0.08),transparent_60%)] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto px-4 lg:px-6 relative z-10 text-center">
        ...
        <div className="quote-text flex flex-col items-center gap-6">
          ...
          <button 
            ...
            className="text-white/40 hover:text-white transition-colors text-sm underline underline-offset-4 decoration-white/20 hover:decoration-white uppercase tracking-wider font-bold"
          >
