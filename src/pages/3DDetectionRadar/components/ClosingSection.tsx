...
export function ClosingSection() {
  return (
    <section className="w-full bg-[#000000] section-padding px-4 sm:px-8 flex flex-col items-center justify-center text-center relative overflow-hidden border-t border-white/10">
