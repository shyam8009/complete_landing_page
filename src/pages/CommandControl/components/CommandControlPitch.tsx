...
export default function CommandControlPitch() {
  return (
        ...
        <div className="flex-1">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight leading-[1.05] mb-8">
              Command <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/40">Architecture.</span>
            </h2>
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            <p className="text-lg sm:text-xl text-white/70 leading-relaxed font-light">
              Modern tactical command centers are inundated with thousands of raw telemetry streams from disparate radars, cameras, and radio sensors, causing critical cognitive fatigue.
            </p>
            
            <p className="text-base sm:text-lg text-white/50 leading-relaxed">
              By merging artificial intelligence with multi-sensor data pipelines, our Command & Control architecture filters noise, automates camera handovers, and presents a crystal-clear 2D/3D operational picture. Direct pipeline synthesis between electronic interception systems and active C2 countermeasures ensures rapid threat mitigation.
            </p>
            
            <div className="grid grid-cols-2 gap-6 pt-8 border-t border-white/10 mt-8">
              <div>
                <div className="text-3xl font-bold text-white mb-2">2D/3D</div>
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">Spatial Awareness</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">Automated</div>
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">Camera Handovers</div>
              </div>
            </div>
          </motion.div>
        </div>
