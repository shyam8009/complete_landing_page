...
export function DeeptechCTA() {
  return (
    <section className="section-padding bg-[#050505] border-t border-white/5 relative overflow-hidden flex items-center justify-center">
      <div className="max-w-4xl mx-auto px-6 text-center z-10 relative">
        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 uppercase tracking-tight leading-snug">
          Accelerate Your Decision Advantage
        </h2>
        
        <p className="text-lg text-white/60 mb-12 max-w-2xl mx-auto">
          Consult with our Deeptech engineers to integrate Big Data analytics, AI models, and secure voice architectures into your communication infrastructure.
        </p>
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <a href="#" className="text-white/40 hover:text-white/80 text-xs tracking-wide transition-colors underline underline-offset-4 decoration-white/20 hover:decoration-white/50 uppercase font-mono mt-4">
            Request Deeptech Capability Brief
          </a>
        </div>
      </div>
    </section>
