...
import heroBg from '@/imports/intelligence_video.mp4';
...
export function DeeptechHero() {
  ...
  const scrollToPitch = () => {
    const pitchSection = document.getElementById('system-pitch-section');
    if (pitchSection) {
      ...
      <div className="relative z-20 w-full px-4 sm:px-6 lg:px-12 max-w-[1600px] mx-auto pt-20 md:pt-0">
        <div className="max-w-3xl flex flex-col items-start text-left">
          ...
          <p className="hero-element text-base sm:text-lg md:text-xl text-white/70 mb-10 max-w-lg leading-relaxed">
            Cognitive overmatch for the modern battlespace. Fusing Artificial Intelligence, Big Data, and advanced Voice Solutions to transform raw intelligence into automated, real-time tactical foresight.
          </p>
          
          {/* CTA */}
          <div className="hero-element flex flex-wrap gap-4 md:gap-6 items-center mb-16">
            <TechCTA onClick={scrollToPitch}>
          ...
          <div className="hero-element flex flex-col md:flex-row gap-6 md:gap-8 p-6 rounded-lg border border-white/10 bg-white/5 backdrop-blur-xl w-full md:max-w-fit">
            <div>
              <div className="text-3xl md:text-4xl font-bold text-white">Machine Learning</div>
              <div className="text-xs md:text-sm font-medium text-white/50 uppercase tracking-widest mt-1">Cognitive Processing</div>
            </div>
            ...
            <div>
              ...
              <div className="text-xs md:text-sm font-medium text-white/50 uppercase tracking-widest mt-1">Secure Deployment</div>
            </div>
          </div>
