...
import { Eye, Shield, Lock, Layers } from 'lucide-react';
...
const PIPELINE_STEPS = [
  {
    ...
    title: "ANTICIPATE",
    icon: Eye,
    description: "Built for the post-quantum threat horizon, so that traffic protected today does not become a readable archive tomorrow."
  },
  {
    id: "02",
    title: "IMPLEMENT",
    icon: Shield,
    description: "Cryptography executed in hardware rather than software alone, resisting tampering and key extraction."
  },
  {
    id: "03",
    title: "PROTECT",
    icon: Lock,
    description: "Security for data at rest and data in transit across sensitive systems."
  },
  {
    id: "04",
    title: "INTEGRATE",
    icon: Layers,
    description: "Deployable alongside existing communication and control infrastructure, without rebuilding it."
  }
];
