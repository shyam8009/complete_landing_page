...
import rfdImg from '@/imports/quantum_atomic_clock.jpg'; // generic hardware image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="fade-in-right text-4xl lg:text-5xl font-bold text-white mb-8 uppercase tracking-tight">
              TAMPER RESISTANCE & FORWARD SECURITY
            </h2>
            
            <div className="fade-in-right space-y-6 text-white/60 text-lg leading-relaxed max-w-xl">
              <p>
                Encrypted traffic recorded today can be stored until a quantum computer capable of breaking it exists. That makes the useful life of an encryption standard shorter than the sensitivity of the data it protects. Hardware-based Post Quantum Cryptography secures data against both classical and quantum decryption, implemented at the hardware level so that keys are harder to extract and the implementation itself harder to tamper with.
              </p>
            </div>
          </div>
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            <div className="hud-element absolute top-[15%] left-[5%] bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                <Cpu className="text-[#84CC16] w-5 h-5" />
                <div>
                  <div className="text-white font-bold text-sm">Hardware-Enabled Implementation</div>
                </div>
              </div>
            </div>
            ...
            <div className="hud-element absolute bottom-[25%] left-0 bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                <Lock className="text-[#84CC16] w-5 h-5" />
                <div>
                  <div className="text-white font-bold text-sm">Data at Rest and In Transit</div>
                </div>
              </div>
            </div>
            ...
            <div className="hud-element absolute top-[40%] right-[5%] bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Deploys Alongside Existing Infrastructure</div>
                </div>
              </div>
            </div>
