...
const COMMITTEES = [
  {
    ...
    subtitle: "as per the provisions of Section 177 of the Companies Act, 2013",
    members: [
      { name: "Mr. Dhawal Akhilesh Deopura", designation: "Chairman" },
      { name: "Ms. Anuja Jain", designation: "Member" },
      { name: "Ms. Pratik Ramjibhai Kakadiya", designation: "Member" },
    ]
  },
  {
    title: "Nomination and Remuneration Committee",
    subtitle: "as per the provisions of Section 178 of the Companies Act, 2013",
    members: [
      { name: "Mr. Anuja Jain", designation: "Chairman" },
      { name: "Ms. Dhawal Akhilesh Deopura", designation: "Member" },
      { name: "Ms. Hetal Pratikbhai Kakadiya", designation: "Member" },
    ]
  }
];

const STATS = [
  { value: "2", label: "Core Committees" },
        ...
        >
          ...
          >
            ...
            <span className="text-[11px] font-bold tracking-[2.5px] text-[#84CC16] uppercase">
              INVESTOR RELATIONS / COMPOSITION OF COMMITTEES
            </span>
          </motion.div>
          ...
          >
            Strategic committees established to ensure robust corporate governance and oversight.
          </motion.p>
  ...
  return (
    <section className="relative bg-slate-50 py-16 md:py-24 border-b border-slate-200" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        ...
        >
          Our purpose is to define and communicate the composition of our committees to ensure effective governance and oversight within our organization. By establishing diverse and skilled committees, we promote <span className="text-[#84CC16] font-medium">accountability</span>, <span className="text-[#84CC16] font-medium">strategic decision-making</span>, and the alignment of our objectives with stakeholder interests, fostering a culture of transparency and integrity.
        </motion.p>
      </motion.div>
    </section>
  );
...
function PersonnelCard({ name, designation, index }: { name: string; designation: string; index: number }) {
      ...
      >
        ...
        <div className="flex items-center gap-4 sm:gap-6 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <span className={`inline-block mt-1.5 text-[10px] font-mono tracking-[2px] uppercase transition-colors duration-300 ${
              hovered ? "text-[#84CC16]" : "text-slate-500"
            }`}>
              {designation}
            </span>
          </div>
        ...
        {/* Right side — NO CTA AS REQUESTED */}
      </div>
    </motion.div>
  );
}
          ...
          {COMMITTEES.map((committee, idx) => (
            ...
            >
              <motion.div variants={fadeUp}>
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-wide mb-1">
                  {committee.title}
                </h3>
              ...
              <div className="flex flex-col gap-3">
                {committee.members.map((member, i) => (
                  <PersonnelCard key={i} name={member.name} designation={member.designation} index={i} />
                ))}
              </div>
            </motion.div>
          ))}
