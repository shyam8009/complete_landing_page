  ...
  return (
    <section className="relative bg-[#050505] py-20 md:py-28 overflow-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        ...
        >
          Our purpose is to define and communicate the composition of our committees to ensure effective governance and oversight within our organization. By establishing diverse and skilled committees, we promote <span className="text-[#84CC16] font-normal">accountability</span>, <span className="text-[#84CC16] font-normal">strategic decision-making</span>, and the alignment of our objectives with stakeholder interests, fostering a culture of transparency and integrity.
        </motion.p>
      </motion.div>
    </section>
  );
