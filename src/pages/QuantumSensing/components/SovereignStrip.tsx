...
export function SovereignStrip() {
  return (
    <section className="w-full bg-white border-y border-slate-200 py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left group">
            <div className="mb-6 p-4 rounded-full bg-slate-50 border border-slate-200 group-hover:border-amber-500/50 group-hover:bg-amber-50 transition-all duration-300">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-amber-600" strokeWidth="1.5">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
              </svg>
            </div>
            <h3 className="text-lg font-bold uppercase tracking-wider text-slate-900 mb-3">
