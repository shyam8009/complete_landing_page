...
export default function QuantumSensingPitch() {
  return (
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            <p className="text-lg sm:text-xl text-white/70 leading-relaxed font-light">
              Classical sensors have reached their physical limits. Modern aerospace and defence require a fundamental leap in measurement physics.
            </p>
            
            <p className="text-base sm:text-lg text-white/50 leading-relaxed">
              Sovereign Dynamics pioneers indigenous quantum sensing hardware to detect the undetectable. From atomic clocks to quantum magnetometers, our systems leverage sub-atomic phenomena to provide un-jammable, ultra-precise navigation and threat detection in completely GPS-denied environments.
            </p>
            
            <div className="grid grid-cols-2 gap-6 pt-8 border-t border-white/10 mt-8">
              <div>
                <div className="text-3xl font-bold text-white mb-2">100<span className="text-lg text-[#84CC16]">x</span></div>
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">Sensitivity Increase</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">0.01<span className="text-lg text-[#84CC16]">s</span></div>
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">Phase Latency</div>
              </div>
            </div>
          </motion.div>
        </div>
