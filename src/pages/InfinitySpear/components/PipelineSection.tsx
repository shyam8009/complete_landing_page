...
import { Eye, Crosshair, Zap, ShieldOff } from 'lucide-react';
...
const PIPELINE_STEPS = [
  {
    ...
    title: "DETECT",
    icon: Eye,
    description: "Identify unauthorized UAV incursions."
  },
  {
    id: "02",
    title: "AIM",
    icon: Crosshair,
    description: "Acquire target via optical or iron sights."
  },
  {
    id: "03",
    title: "ENGAGE",
    icon: Zap,
    description: "Deploy targeted multi-band jamming."
  },
  {
    id: "04",
    title: "NEUTRALIZE",
    icon: ShieldOff,
    description: "Force drone into return-to-home or safe-land protocol."
  }
];
