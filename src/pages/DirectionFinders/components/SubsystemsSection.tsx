...
import imgInter from '@/imports/surveillance_radar_hero.png';
import imgTdoa from '@/imports/digital_node_map.jpg';
import imgTerrain from '@/imports/digital_twin.jpg';
