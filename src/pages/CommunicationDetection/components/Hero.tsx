...
import bgVideo from '@/imports/intelligence_video.mp4';
    ...
    <section className="relative w-full h-screen bg-[#050505] overflow-hidden flex items-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        <div className="max-w-3xl">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 uppercase tracking-tight leading-[1.1]">
          ...
          >
            Secure, real-time tactical observation and soldier-level threat telemetry. Unifying modular long-range surveillance with wearable intelligence for total operational awareness across all echelons.
          </motion.p>
