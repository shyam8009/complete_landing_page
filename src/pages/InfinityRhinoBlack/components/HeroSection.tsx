    ...
    <section ref={containerRef} className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-20 h-full flex flex-col justify-center px-6 lg:px-12 max-w-[1600px] mx-auto">
        <div className="max-w-3xl">
          ...
          >
            INFINITY RHINO <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">BLACK</span>
          </h1>
          
          {/* Subheadline */}
          <p className="hero-element text-xl text-white/60 mb-10 max-w-lg leading-relaxed">
            A portable anti-drone manpack jammer, specifically built for military and security personnel.
          </p>
          ...
          <div className="hero-element flex flex-wrap gap-8 p-6 rounded-lg border border-white/10 bg-white/5 backdrop-blur-xl max-w-fit">
            <div>
              ...
              <div className="text-sm font-medium text-white/50 uppercase tracking-widest mt-1">Frequency Channels</div>
            </div>
            <div className="w-px bg-white/20" />
            <div>
              <div className="text-2xl font-bold text-white">2 km</div>
              <div className="text-sm font-medium text-white/50 uppercase tracking-widest mt-1">Omni-Directional Neutralization</div>
            </div>
          </div>
