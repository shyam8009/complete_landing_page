...
import { Activity, Network, Send, Shield } from 'lucide-react';
const PIPELINE_STEPS = [
  {
    id: "01",
    title: "GENERATE",
    icon: Activity,
    description: "High-speed quantum random number generation produces cryptographically secure randomness at over 2 Gbps, with continuous entropy validation."
  },
  {
    id: "02",
    title: "DISTRIBUTE",
    icon: Network,
    description: "Quantum key distribution over fibre, where any attempt to intercept the key disturbs it and is detected at both ends."
  },
  {
    id: "03",
    title: "EXTEND",
    icon: Send,
    description: "Drone-relay architectures carry secure quantum links across terrain where fibre cannot be laid."
  },
  {
    id: "04",
    title: "SECURE",
    icon: Shield,
    description: "Military-grade encryption for operations that cannot afford a compromised channel."
  }
];
