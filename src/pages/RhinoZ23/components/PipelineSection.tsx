...
import { Target, Radar, Zap, Sliders } from 'lucide-react';
...
const PIPELINE_STEPS = [
  {
    ...
    title: "MOUNT",
    icon: Target,
    description: "Highly versatile deployment with direct integration capabilities for the Zu-23 anti-aircraft gun platform, backpacks, or poles."
  },
  {
    id: "02",
    title: "TARGET",
    icon: Radar,
    description: "Flexible signal geometry allowing operators to switch between omni-directional bubble defense and targeted directional jamming."
  },
  {
    id: "03",
    title: "DISRUPT",
    icon: Zap,
    description: "Multi-frequency 5-channel operation emitting 160 W of power for robust threat neutralization."
  },
  {
    id: "04",
    title: "COMMAND",
    icon: Sliders,
    description: "Wired remote control system allowing for safe, standoff operation and specific channel control."
  }
];
