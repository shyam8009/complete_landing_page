...
import { Radar, Crosshair, Zap, Shield } from 'lucide-react';
...
const PIPELINE_STEPS = [
  {
    ...
    title: "SCAN",
    icon: Radar,
    description: "Continuous 360-degree airspace monitoring."
  },
  {
    id: "02",
    title: "CLASSIFY",
    icon: Crosshair,
    description: "AI-driven threat profiling and targeting."
  },
  {
    id: "03",
    title: "OVERRIDE",
    icon: Zap,
    description: "High-powered frequency domination."
  },
  {
    id: "04",
    title: "SECURE",
    icon: Shield,
    description: "Maintain sterile airspace perimeter."
  }
];
