...
import { Radar, Activity, Crosshair, Zap } from 'lucide-react';
...
const PIPELINE_STEPS = [
  {
    ...
    title: "SCAN",
    icon: Radar,
    description: "Continuous broad-spectrum RF scanning."
  },
  {
    id: "02",
    title: "DETECT",
    icon: Activity,
    description: "Identify drone telemetry and video links."
  },
  {
    id: "03",
    title: "LOCATE",
    icon: Crosshair,
    description: "Pinpoint operator and drone bearing."
  },
  {
    id: "04",
    title: "ALERT",
    icon: Zap,
    description: "Instant notification to C2 systems."
  }
];
