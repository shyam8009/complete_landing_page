...
export function QuantumCommunicationPitch() {
  return (
        ...
        <div className="flex-1">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight leading-[1.05] mb-8">
              Sovereign <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/40">Encryption.</span>
            </h2>
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            <p className="text-lg sm:text-xl text-white/70 leading-relaxed font-light">
              As adversarial computing power scales, traditional cryptography algorithms become mathematically obsolete and vulnerable.
            </p>
            
            <p className="text-base sm:text-lg text-white/50 leading-relaxed">
              Sahana Defence builds indigenous quantum communication hardware across three platforms. Quantum key distribution makes interception detectable rather than silent. Post-quantum cryptography protects data against decryption by machines that do not yet exist. Together they secure India's most sensitive channels without depending on foreign infrastructure.
            </p>
            
            <div className="grid grid-cols-2 gap-6 pt-8 border-t border-white/10 mt-8">
              <div>
                <div className="text-3xl font-bold text-white mb-2">Over 2 Gbps</div>
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">QRNG THROUGHPUT</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">Three</div>
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">COMMUNICATION PLATFORMS</div>
              </div>
            </div>
          </motion.div>
        </div>
