...
export default function QuantumCommunicationPitch() {
  return (
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white/50 leading-relaxed">
              Sahana's Quantum Key Distribution (QKD) and post-quantum encryption architectures ensure absolute data sovereignty. By relying on the fundamental laws of quantum mechanics rather than mathematical complexity, we build impenetrable networks that are physically impossible to intercept without immediate detection.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 pt-8 border-t border-white/10 mt-8">
              <div>
                ...
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">Cryptographic Secrecy</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">QKD<span className="text-lg text-[#84CC16]">-Ready</span></div>
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">Hardware Standard</div>
              </div>
            </div>
          </motion.div>
        </div>
