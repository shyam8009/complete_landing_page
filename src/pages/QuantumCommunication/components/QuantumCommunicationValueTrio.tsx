...
export function QuantumCommunicationValueTrio() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left group">
            ...
            <p className="text-sm text-white/60 leading-relaxed">
              Built for the operational realities of aerospace and contested environments.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left group">
            ...
            <p className="text-sm text-white/60 leading-relaxed">
              Sovereign capability with no foreign dependency in the critical path.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left group">
            ...
            <h3 className="text-lg font-bold uppercase tracking-wider text-white mb-3">
              DETECTABLE INTERCEPTION
            </h3>
            <p className="text-sm text-white/60 leading-relaxed">
              Key exchange where an eavesdropper cannot listen without leaving evidence.
            </p>
          </div>
