...
const PIPELINE_STEPS = [
  {
    ...
    title: "REFERENCE",
    icon: Network,
    description: "Frequency stability at the quantum limit, providing a timing baseline that holds without an external signal."
  },
  {
    id: "02",
    title: "SUSTAIN",
    icon: Activity,
    description: "Sovereign, GPS-independent timing for navigation and Radar systems operating in contested conditions."
  },
  {
    id: "03",
    title: "SYNCHRONISE",
    icon: Crosshair,
    description: "A common time base across distributed sensor and communication networks, holding coherence between nodes."
  },
  {
    id: "04",
    title: "HARDEN",
    icon: Cpu,
    description: "Built for defence-grade reliability in contested environments, where external timing cannot be assumed."
  }
];
