...
import heroBg from '@/imports/radio-monitoring/hero.png'; 
      ...
      <div className="relative z-20 flex-1 flex flex-col justify-center pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-10 md:pb-12 w-full px-4 sm:px-6 lg:px-12 max-w-[1600px] mx-auto">
        <div className="max-w-4xl">
          ...
          <p className="hero-element text-lg sm:text-xl text-white/60 mb-10 max-w-xl leading-relaxed">
            Comprehensive wideband receivers and monitoring suites engineered to detect, intercept, and analyze complex radio frequency emissions across congested spectrums.
          </p>
          ...
          <div className="hero-element flex flex-col md:flex-row gap-4 md:gap-8 p-4 sm:p-6 rounded-lg mt-6 md:mt-12 border border-white/10 bg-white/5 backdrop-blur-xl w-full sm:w-auto max-w-full">
            <div>
              <div className="text-2xl font-bold text-white">VLF to SHF</div>
              <div className="text-sm font-medium text-white/50 uppercase tracking-widest mt-1">Wideband Coverage</div>
            </div>
            <div className="hidden md:block w-px bg-white/20" /><div className="block md:hidden h-px w-full bg-white/20" />
            <div>
              <div className="text-2xl font-bold text-white">Multi-Channel</div>
              <div className="text-sm font-medium text-white/50 uppercase tracking-widest mt-1">Simultaneous Interception</div>
            </div>
          </div>
