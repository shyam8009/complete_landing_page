  ...
  return (
    <section className="relative bg-[#050505] py-20 md:py-28 overflow-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        ...
        >
          Our purpose is to present precise, transparent, and insightful subsidiary financial results that demonstrate our dedication to <span className="text-[#84CC16] font-normal">integrity and accountability</span>. By providing clear and detailed financial information, we enable stakeholders to evaluate subsidiary performance effectively and contribute to the overall sustainable growth of our organization.
        </motion.p>
      </motion.div>
    </section>
  );
