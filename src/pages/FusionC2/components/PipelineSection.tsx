...
import { Network, Map, Radar, Crosshair } from 'lucide-react';
...
const PIPELINE_STEPS = [
  {
    ...
    title: "INTEGRATE",
    icon: Network,
    description: "Unifies complex sensor data—such as radar tracks, live video, and system health—into a simple, easily digestible 2D and 3D interface."
  },
  {
    id: "02",
    title: "MAP",
    icon: Map,
    description: "Features 2D Operational Mapping for quick assessment and 3D Situational Awareness Mapping to grasp spatial relationships, obstacles, and advantageous positions."
  },
  {
    id: "03",
    title: "TRACK",
    icon: Radar,
    description: "Simultaneously tracks over 1000+ objects in real-time, integrating Blue Force tracking for absolute spatial dominance."
  },
  {
    id: "04",
    title: "ENGAGE",
    icon: Crosshair,
    description: "Enables intuitive operation of sensors and effectors, with target selection based on type for precision monitoring."
  }
];
            ...
            return (
              ...
              >
                ...
                <div className="mb-8 flex flex-col items-center justify-center w-20 h-20 rounded-full bg-[#0a0a0a] border border-white/10 group-hover:bg-[#111111] transition-all duration-500 relative z-10 shadow-xl">
                  <div className="absolute top-2 text-[10px] text-[#84CC16] font-mono tracking-widest font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    {step.id}
                  </div>
