        ...
        <div className="flex-1">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight leading-[1.05] mb-8">
              The Backbone of <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/40">Modern Defence.</span>
            </h2>
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            <p className="text-lg sm:text-xl text-white/70 leading-relaxed font-light">
              In mission-critical environments, communication is only as strong as the network that carries it.
            </p>
            
            <p className="text-base sm:text-lg text-white/50 leading-relaxed">
              Sahana's Connectivity & Infrastructure practice covers IoT integration, cloud architecture, and live video and streaming delivery, giving defence and enterprise teams a dependable foundation to run on. Architected and supported by our in-house engineering team, our solutions use cloud-native and serverless approaches designed to grow seamlessly with operational demand.
            </p>
            
            <div className="grid grid-cols-2 gap-6 pt-8 border-t border-white/10 mt-8">
              <div>
                <div className="text-3xl font-bold text-white mb-2">End-to-End</div>
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">Infrastructure</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">Compliance</div>
                <div className="text-xs text-white/40 uppercase tracking-widest font-mono">Security First</div>
              </div>
            </div>
          </motion.div>
        </div>
