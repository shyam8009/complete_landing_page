...
import airDefenseImg from '@/imports/surveillance_radar_hero.png';
import militaryImg from '@/imports/fpv-buddy/tactical_2.webp';
import marineImg from '@/imports/c2_dashboard_ui.png';
...
export function ElectroOpticsUseCases() {
