...
import trackingVid from '@/imports/surveillance_radar_hero_bg.mp4';

const heroSlides = [
  {
    id: 'electro-optics-core',
    title: 'Electro-Optics',
    subtitle: 'Advanced Thermal Imaging & Laser Rangefinding',
    mediaUrl: eoVid,
    ctaText: 'EXPLORE ELECTRO-OPTICS',
    ctaLink: '/electronic-warfare/electro-optics',
  },
  {
    id: 'tactical-imaging',
    title: 'Tactical Imaging',
    subtitle: 'Day/Night Vision & Target Tracking',
    mediaUrl: trackingVid,
    ctaText: 'SEE IMAGING',
    ctaLink: '/electronic-warfare/electro-optics',
  }
];
