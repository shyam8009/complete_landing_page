  ...
  return (
    <section className="relative bg-[#050505] py-20 md:py-28 overflow-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        ...
        >
          Our purpose is to provide transparent access to our statutory annual returns, ensuring complete <span className="text-[#84CC16] font-normal">compliance with regulatory authorities</span> and reinforcing our commitment to clear, accessible corporate governance for all stakeholders.
        </motion.p>
      </motion.div>
    </section>
  );
