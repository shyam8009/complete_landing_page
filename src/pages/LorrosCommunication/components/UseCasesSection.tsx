...
import imgBorder from '@/imports/lorros/border_protection.jpg';
import imgCoastal from '@/imports/lorros/coastal_defense.jpg';
import imgSecurity from '@/imports/lorros/critical_site_security.png';
