...
import { Target, ThermometerSun, Radio } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="vp-text text-lg text-white/60 leading-relaxed max-w-xl">
              Designed as a highly configurable solution, LORROS can be tailored to precise mission requirements, supporting both stand-alone and networked operations. Its flexible architecture allows seamless integration with multiple sensor types and communication networks. Individual sensors can be controlled from different stations, enabling scalable deployment and total situational awareness for strategic defense operators.
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/2 relative min-h-[500px] flex items-center justify-center">
            ...
            <div className="vp-hud absolute top-[50%] -right-[5%] z-20 flex items-center gap-3 px-4 py-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-lg">
              <div className="w-8 h-8 rounded-full bg-[#84CC16]/20 flex items-center justify-center">
                <ThermometerSun className="w-4 h-4 text-[#84CC16]" />
              </div>
              <div>
