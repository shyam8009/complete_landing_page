...
// Using surveillance radar hero bg as placeholder. 
// NOTE: Final video needs to have 0:02-0:03 and 0:09-0:10 segments cropped, 4-story building, cleared ground floor, no flags/humans.
    ...
    <section ref={containerRef} className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-20 h-full flex flex-col justify-center px-6 lg:px-12 max-w-[1600px] mx-auto">
        <div className="max-w-3xl">
          ...
          {/* Headline */}
          <h1 
            className="hero-element text-5xl lg:text-7xl font-bold mb-6 uppercase leading-[1.1] tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-white to-neutral-500"
          ...
          <p className="hero-element text-xl text-white/60 mb-10 max-w-lg leading-relaxed">
            Modular long-range reconnaissance and observation for border protection, coastal defense, and critical site security.
          </p>
          ...
          <div className="hero-element flex flex-wrap gap-8 p-6 rounded-lg border border-white/10 bg-white/5 backdrop-blur-xl max-w-fit">
            <div>
              <div className="text-2xl font-bold text-white">Multi-Sensor</div>
              <div className="text-sm font-medium text-white/50 uppercase tracking-widest mt-1">EO/IR Integration</div>
            </div>
            <div className="w-px bg-white/20" />
            <div>
              <div className="text-2xl font-bold text-white">Scalable</div>
              <div className="text-sm font-medium text-white/50 uppercase tracking-widest mt-1">C2 Network Ready</div>
            </div>
          </div>
