...
import imgInfra from '@/imports/security-assessment/critical_infrastructure_protection.jpg';
import imgC2 from '@/imports/security-assessment/command_control_facilities.jpg';
import imgFob from '@/imports/security-assessment/forward_operating_bases.jpg';
...
const USE_CASES = [
  {
    ...
    desc: "Hardening energy grids, communication hubs, and national assets against multi-vector cyber-physical attacks.",
    image: imgInfra
  },
  {
    id: "02",
    title: "Command & Control Facilities",
    desc: "Securing tactical headquarters and data centers against unauthorized physical and digital infiltration.",
    image: imgC2
  },
  {
    id: "03",
    title: "Forward Operating Bases (FOB)",
    desc: "Evaluating perimeter security and electronic communication pathways in contested, high-threat deployment zones.",
    image: imgFob
  }
];
...
export function UseCasesSection() {
  ...
  return (
    <section ref={sectionRef} className="section-padding bg-[#000000] relative">
