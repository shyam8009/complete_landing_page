...
import { Crosshair, Activity, ShieldCheck } from 'lucide-react';
import productImg from '@/imports/digital_twin.jpg';
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="vp-text text-lg text-white/60 leading-relaxed max-w-xl">
              A comprehensive security assessment is a holistic, multi-vector evaluation of physical and digital security postures. We simulate advanced persistent threats (APTs) and kinetic breaches to identify critical vulnerabilities within infrastructure, networks, and operational protocols before adversaries can exploit them. By bridging the gap between physical perimeter security and cyber-electronic defense, we ensure absolute resilience across all operational echelons.
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/2 relative min-h-[500px] flex items-center justify-center">
            ...
            <div className="vp-image-container relative z-10 w-full max-w-xl">
              <img 
                src={productImg} 
                alt="Digital twin mapping red-team vulnerabilities" 
            ...
            <div className="vp-hud absolute top-[10%] -left-[5%] z-20 flex items-center gap-3 px-4 py-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-lg">
              ...
              <div>
                ...
                <div className="text-sm font-bold text-white">Perimeter Infiltration Testing</div>
              </div>
            </div>
            ...
            <div className="vp-hud absolute top-[50%] -right-[5%] z-20 flex items-center gap-3 px-4 py-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-lg">
              ...
              <div>
                ...
                <div className="text-sm font-bold text-white">Risk Matrix Vector Mapping</div>
              </div>
            </div>
            ...
            <div className="vp-hud absolute bottom-[10%] left-[10%] z-20 flex items-center gap-3 px-4 py-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-lg">
              ...
              <div>
                ...
                <div className="text-sm font-bold text-white">Protocol Hardening Framework</div>
              </div>
            </div>
