...
const PIPELINE_STEPS = [
  {
    ...
    title: "DEPLOY",
    icon: Network,
    description: "Available as a managed service or built to mission specification, matched to the operational requirement."
  },
  {
    id: "02",
    title: "NAVIGATE",
    icon: Activity,
    description: "Onboard quantum sensing supports navigation where satellite signals are jammed, spoofed or simply absent."
  },
  {
    id: "03",
    title: "DETECT",
    icon: Crosshair,
    description: "Quantum sensing payloads for surveillance and threat detection across the operating environment."
  },
  {
    id: "04",
    title: "ENDURE",
    icon: Cpu,
    description: "Engineered for the operational realities of contested airspace and aerospace and defence deployment."
  }
];
