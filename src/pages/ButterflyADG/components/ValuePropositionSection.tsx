...
import butterflyModelImg from '../../../imports/butterfly-adg/magnific_professional-studio-produ_xgQveAGjfW.png';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="fade-in-right text-4xl lg:text-5xl font-bold text-white mb-8 uppercase tracking-tight">
              Airspace Dominance & Platform Synergy
            </h2>
            
            <div className="fade-in-right space-y-6 text-white/60 text-lg leading-relaxed max-w-xl">
              <p>
                The Infinity Butterfly L70 integrates advanced jamming technology with the robust capabilities of the L70 platform for military applications. It provides versatile, all-weather, day and night protection against hostile drones, ensuring sustained operational superiority in high-stress, dynamic battlefield environments.
              </p>
            </div>
          </div>
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            {/* Central Render */}
            <img 
              src={butterflyModelImg} 
              alt="Butterfly ADG L70" 
            ...
            <div className="hud-element absolute top-[40%] right-[5%] bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">12 kg Total Weight</div>
                </div>
              </div>
            </div>
