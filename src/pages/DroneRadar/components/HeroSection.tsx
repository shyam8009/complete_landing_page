...
export function HeroSection() {
  return (
    <section className="relative min-h-[100dvh] max-md:landscape:min-h-[60vh] flex flex-col justify-between overflow-hidden bg-black pt-20 sm:pt-24 md:pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-10 md:pb-12">
          ...
          <div className="flex flex-col items-start fade-up">
            ...
            <div className="grid grid-cols-2 gap-8 mt-16 p-6 border border-white/10 rounded-xl backdrop-blur-md bg-black/40 w-full sm:w-fit shadow-2xl">
              ...
              <div>
                ...
                <div className="text-sm text-white/50 font-mono uppercase">Target Acquisition</div>
              </div>
            </div>
          </div>
        </div>
