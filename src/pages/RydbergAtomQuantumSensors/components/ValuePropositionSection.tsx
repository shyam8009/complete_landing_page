...
import { Thermometer, Radio, ShieldCheck } from 'lucide-react';
import gsap from 'gsap';
import { ScrollTrigger } from 'gsap/ScrollTrigger';
import rfdImg from '../../../imports/quantum_rfd_detect.jpg';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="fade-in-right text-4xl lg:text-5xl font-bold text-white mb-8 uppercase tracking-tight">
              ATOMIC PRECISION & FIELD DEPLOYMENT
            </h2>
            
            <div className="fade-in-right space-y-6 text-white/60 text-lg leading-relaxed max-w-xl">
              <p>
                Rydberg Atom Quantum Sensors detect electromagnetic fields through the atoms themselves rather than through a conventional antenna, which moves the sensitivity limit into ranges classical hardware cannot reach. The line bridges quantum theory and defence-grade field deployment, and complements the quantum magnetometer and wideband RF detector portfolio.
              </p>
            </div>
          </div>
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            <img 
              src={rfdImg} 
              alt="Rydberg Atom Quantum Sensors" 
            ...
            <div className="hud-element absolute top-[15%] left-[5%] bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Ultra-High Sensitivity</div>
                </div>
              </div>
            </div>
            ...
            <div className="hud-element absolute bottom-[25%] left-0 bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Atomic Reference Standard</div>
                </div>
              </div>
            </div>
            ...
            <div className="hud-element absolute top-[40%] right-[5%] bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Aerospace & Defence Engineered</div>
                </div>
              </div>
            </div>
