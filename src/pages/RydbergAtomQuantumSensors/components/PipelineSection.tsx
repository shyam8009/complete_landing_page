...
import { Network, Activity, Crosshair, Cpu } from 'lucide-react';
...
const PIPELINE_STEPS = [
  {
    ...
    title: "EXCITE",
    icon: Network,
    description: "Atoms are driven into Rydberg states, where an electron sits in a vastly extended orbit, and the atom becomes acutely responsive to electromagnetic fields."
  },
  {
    id: "02",
    title: "SENSE",
    icon: Activity,
    description: "An incoming field alters the optical behaviour of the atomic vapour, turning an electromagnetic measurement into an optical one."
  },
  {
    id: "03",
    title: "RESOLVE",
    icon: Crosshair,
    description: "Sensitivity that reaches into ranges where classical RF sensors return nothing usable."
  },
  {
    id: "04",
    title: "DEPLOY",
    icon: Cpu,
    description: "Engineered for aerospace and defence, alongside the quantum magnetometer and wideband RF detector portfolio."
  }
];
