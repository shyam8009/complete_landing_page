...
const PIPELINE_STEPS = [
  {
    ...
    title: "CONVERT",
    icon: Radio,
    description: "Bypasses standard electronic jamming by seamless conversion from easily tracked ISM frequencies to secure non-ISM frequency bands."
  },
  {
    id: "02",
    title: "DEPLOY",
  ...
  },
  {
    ...
    title: "SECURE",
    icon: Shield,
    description: "Supports simultaneous multi-band operation in both open and encrypted tactical modes."
  },
  {
    id: "04",
    title: "COMMAND",
    icon: Signal,
    description: "Maintains reliable telemetry via wireless link or up to 120 meters of secure wired line operation."
  }
];
