...
import varunaModelImg from '../../../imports/varuna/magnific_a-photorealistic-highend-_gJ5ArwISXO.png';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="fade-in-right text-4xl lg:text-5xl font-bold text-white mb-8 uppercase tracking-tight">
              Sub-Surface Agility & Clarity
            </h2>
            
            <div className="fade-in-right space-y-6 text-white/60 text-lg leading-relaxed max-w-xl">
              <p>
                Varuna is a state-of-the-art underwater drone designed for professionals and enthusiasts requiring robust endurance beneath the surface. It delivers exceptional maneuverability using a 5-motor system equipped with advanced self-stabilization and depth hold logic.
              </p>
            </div>
          </div>
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            <img 
              ...
              className="relative z-10 w-full max-w-[600px] object-contain drop-shadow-[0_0_50px_rgba(132,204,22,0.1)] hover:scale-105 transition-transform duration-700 rounded-lg"
            />
            ...
            <div className="hud-element absolute top-[15%] left-[5%] bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Saltwater & Freshwater Compatible</div>
                </div>
              </div>
            </div>
            ...
            <div className="hud-element absolute bottom-[25%] left-0 bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                <Anchor className="text-[#84CC16] w-5 h-5" />
                <div>
                  <div className="text-white font-bold text-sm">5-Motor Propulsion System</div>
                </div>
              </div>
            </div>
            ...
            <div className="hud-element absolute top-[40%] right-[5%] bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Top Speed: 2 m/s</div>
                </div>
              </div>
            </div>
