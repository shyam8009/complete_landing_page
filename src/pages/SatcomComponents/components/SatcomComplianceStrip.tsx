...
const metrics = [
  {
    title: "Zero Signal Deviation",
    description: "Eliminating minor mechanical deviations to ensure absolute signal quality and uninterrupted satellite communication links."
  },
  {
    title: "Dimensional Stability",
    description: "Structures engineered and validated to endure the extreme thermal fluctuations and mechanical stresses of orbital lifecycles."
  },
  {
    title: "RF Engineering Excellence",
    description: "Adhering to the highest precision RF manufacturing practices for C-band, Ku-band, and complex microwave assemblies."
  }
];

export function SatcomComplianceStrip() {
