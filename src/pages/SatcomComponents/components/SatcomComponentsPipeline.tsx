...
const PIPELINE_STEPS = [
  {
    ...
    title: "ENGINEER",
    icon: PenTool,
    desc: "Precision engineering modeling to ensure RF assemblies and antenna structures meet the strict performance requirements of satellite communication links."
  },
  {
    id: "02",
    title: "FABRICATE",
    icon: Target,
    desc: "Multi-axis CNC machining of complex waveguide routing and pedestal assemblies using specialized materials like INVAR for thermal stability."
  },
  {
    id: "03",
    title: "INTEGRATE",
    icon: Layers,
    desc: "High-precision assembly of C-band and Ku-band components, ensuring flawless physical connections for power dividers, couplers, and RF receivers."
  },
  {
    id: "04",
    title: "VALIDATE",
    icon: ScanLine,
    desc: "Rigorous dimensional and surface inspection to eliminate minor deviations, guaranteeing zero degradation to signal quality across the mission."
  }
];

export function SatcomComponentsPipeline() {
