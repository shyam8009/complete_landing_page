...
const PIPELINE_STEPS = [
  ...
  },
  {
    ...
    title: "ACQUIRE",
    icon: Activity,
    description: "The full RF and microwave range stays covered at once, with no retuning between bands."
  },
  {
    id: "03",
    title: "RESOLVE",
    icon: Crosshair,
    description: "Detection engineered to pull weak returns and low-power emitters clear of a crowded noise floor."
  },
  {
    id: "04",
    title: "INTEGRATE",
    icon: Cpu,
    description: "Indigenous design with no foreign dependency in the critical path, from first stage through to readout."
  }
];
