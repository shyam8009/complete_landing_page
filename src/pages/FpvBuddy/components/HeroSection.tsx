...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative w-full min-h-[100dvh] overflow-hidden bg-black flex flex-col">
      ...
      {/* Content Container */}
      <div className="relative z-20 flex-1 flex flex-col justify-center pt-20 sm:pt-24 md:pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-10 md:pb-12 w-full pt-20 sm:pt-24 md:pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-10 md:pb-12 px-4 sm:px-4 sm:px-6 lg:px-12 max-w-[1600px] mx-auto">
