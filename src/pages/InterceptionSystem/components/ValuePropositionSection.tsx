...
import { Activity, RadioReceiver, Eye } from 'lucide-react';
import productImg from '@/imports/rf_radar_generated.png';
...
export function ValuePropositionSection() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full section-padding bg-[#000000] overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="vp-text text-2xl sm:text-4xl lg:text-6xl font-bold text-white mb-8 leading-[1.1] tracking-tight" style={{ fontFamily: INTER }}>
              Covert Spectrum Dominance.
            </h2>
            
            <p className="vp-text text-lg text-white/60 leading-relaxed max-w-xl">
              The Interception System is a critical electronic warfare asset engineered for multi-domain dominance. By passively monitoring the electromagnetic spectrum, it provides early warning and actionable intelligence without revealing operational positions. It allows tactical commanders to listen in on encrypted hostile communications, map adversary networks, and neutralize threats before they can execute kinetic strikes.
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/2 relative min-h-[500px] flex items-center justify-center">
            ...
            <div className="vp-image-container relative z-10 w-full max-w-xl">
              <img 
                src={productImg} 
                alt="Tactical Frequency Spectrum Dashboard" 
            ...
            <div className="vp-hud absolute top-[10%] -left-[5%] z-20 flex items-center gap-3 px-4 py-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-lg">
              ...
              <div>
                ...
                <div className="text-sm font-bold text-white">Real-Time Signal Demodulation</div>
              </div>
            </div>
            ...
            <div className="vp-hud absolute top-[50%] -right-[5%] z-20 flex items-center gap-3 px-4 py-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-lg">
              <div className="w-8 h-8 rounded-full bg-[#84CC16]/20 flex items-center justify-center">
                <RadioReceiver className="w-4 h-4 text-[#84CC16]" />
              </div>
              <div>
                <div className="text-[10px] text-white/50 font-mono tracking-wider uppercase">Live</div>
                <div className="text-sm font-bold text-white">Hostile Emitter Tracking</div>
              </div>
            </div>
            ...
            <div className="vp-hud absolute bottom-[10%] left-[10%] z-20 flex items-center gap-3 px-4 py-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-lg">
              ...
              <div>
                <div className="text-[10px] text-white/50 font-mono tracking-wider uppercase">Covert</div>
                <div className="text-sm font-bold text-white">Passive Intelligence Gathering</div>
              </div>
            </div>
