...
import { Shield, Activity, Radio, Target } from 'lucide-react';
...
const PIPELINE_STEPS = [
  {
    ...
    title: "WEAR",
    icon: Shield,
    description: "Ergonomic fit designed for continuous use without hindering combat effectiveness or mobility."
  },
  {
    id: "02",
    title: "MONITOR",
    icon: Activity,
    description: "Real-time tracking of vital signs, fatigue levels, and physical readiness in the field."
  },
  {
    id: "03",
    title: "SYNC",
    icon: Radio,
    description: "Encrypted data transmission ensures that sensitive biometric information reaches command securely."
  },
  {
    id: "04",
    title: "COMMAND",
    icon: Target,
    description: "Seamless integration with C2 systems for enhanced tactical situational awareness."
  }
];
