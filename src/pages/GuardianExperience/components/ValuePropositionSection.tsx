...
import guardianModelImg from '../../../imports/guardian/magnific_professional-studio-produ_brfvUMF5Y2.png';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="fade-in-right space-y-6 text-white/60 text-lg leading-relaxed max-w-xl">
              <p>
                The Guardian Smart Soldier Band seamlessly connects the dismounted soldier to the command center while monitoring vital signs and combat readiness. Designed for the harshest environments, it provides real-time biometric telemetry and secure communication to ensure tactical superiority and team safety.
              </p>
            </div>
          </div>
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            <div className="hud-element absolute top-[15%] left-[5%] bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Biometric Sensors</div>
                </div>
              </div>
            </div>
            ...
            <div className="hud-element absolute bottom-[25%] left-0 bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Encrypted Comm Link</div>
                </div>
              </div>
            </div>
            ...
            <div className="hud-element absolute top-[40%] right-[5%] bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-md z-20 shadow-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Ruggedized Design</div>
                </div>
              </div>
            </div>
