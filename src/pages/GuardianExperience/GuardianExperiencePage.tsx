    ...
    <div ref={containerRef} className="w-full bg-[#05080D] text-white min-h-screen font-sans">
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden pt-20 px-6">
        ...
        <div className="relative z-10 max-w-[1200px] w-full mx-auto text-center flex flex-col items-center gsap-fade-up">
          <span className="text-[#3C5929] text-xs md:text-sm font-bold uppercase tracking-[4px] mb-4">Tactical Threat Detection Wearable</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <button className="bg-[#3C5929] text-black px-8 py-4 font-bold uppercase tracking-wider text-sm hover:bg-white transition-colors">
        ...
        <div className="max-w-[1400px] mx-auto gsap-fade-up">
          ...
          <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-white/10 shadow-2xl group">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-20 h-20 rounded-full bg-[#3C5929]/20 backdrop-blur-sm border border-[#3C5929]/50 flex items-center justify-center cursor-pointer hover:scale-110 transition-transform">
                 <div className="w-0 h-0 border-t-[10px] border-t-transparent border-l-[16px] border-l-[#3C5929] border-b-[10px] border-b-transparent ml-1"></div>
              </div>
            </div>
            ...
            <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:w-96 bg-black/40 backdrop-blur-xl border border-white/10 p-6 rounded-lg">
               <div className="flex items-center justify-between mb-2">
                 <span className="text-[#3C5929] text-xs font-bold uppercase tracking-wider">Target Acquired</span>
                 <span className="text-xs text-white/50 font-mono">2.4km</span>
               </div>
               <div className="h-1 w-full bg-white/10 rounded-full overflow-hidden mb-4"><div className="h-full bg-[#3C5929] w-3/4"></div></div>
      ...
      <section className="w-full py-32 px-6 bg-black">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center gsap-fade-up">
          <div className="flex flex-col gap-8">
            <span className="text-[#3C5929] text-xs font-bold uppercase tracking-[4px]">Core Architecture</span>
            ...
            <div className="flex gap-4 items-start bg-white/5 p-6 border border-white/10 rounded-lg">
               <Crosshair className="w-8 h-8 text-[#3C5929] shrink-0" />
               <div>
          ...
          <div className="relative aspect-square md:aspect-[4/3] bg-[#05080D] border border-white/10 rounded-xl overflow-hidden p-8 flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-[#3C5929]/10 to-transparent pointer-events-none"></div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-32 px-6 bg-[#05080D]">
        <div className="max-w-[1400px] mx-auto flex flex-col gap-12 gsap-fade-up">
          <div className="text-center max-w-3xl mx-auto">
            <span className="text-[#3C5929] text-xs font-bold uppercase tracking-[4px] mb-4 block">Bento Architecture</span>
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight">Core Capabilities</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
            {/* Card 1 (Large) */}
            <div className="md:col-span-2 md:row-span-2 bg-gradient-to-br from-white/5 to-transparent border border-white/10 p-8 rounded-xl flex flex-col justify-between group hover:border-[#3C5929]/50 transition-colors">
              <div className="flex justify-between items-start">
                <Crosshair className="w-10 h-10 text-[#3C5929]" />
            ...
            {/* Card 2 */}
            <div className="bg-gradient-to-br from-white/5 to-transparent border border-white/10 p-8 rounded-xl flex flex-col justify-between group hover:border-[#3C5929]/50 transition-colors">
              <Activity className="w-8 h-8 text-[#3C5929]" />
              <div>
            ...
            {/* Card 3 */}
            <div className="bg-gradient-to-br from-white/5 to-transparent border border-white/10 p-8 rounded-xl flex flex-col justify-between group hover:border-[#3C5929]/50 transition-colors">
              <Wind className="w-8 h-8 text-[#3C5929]" />
              <div>
            ...
            {/* Card 4 (Wide) */}
            <div className="md:col-span-3 bg-gradient-to-r from-white/5 to-transparent border border-white/10 p-8 rounded-xl flex flex-col md:flex-row items-center gap-8 group hover:border-[#3C5929]/50 transition-colors">
              <MapPin className="w-12 h-12 text-[#3C5929] shrink-0" />
              <div>
         ...
         <div className="max-w-[1400px] mx-auto gsap-fade-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div className="border border-white/10 p-8 rounded-xl bg-[#05080D] flex flex-col">
                 ...
                 <button className="text-[#3C5929] text-sm font-bold uppercase tracking-wider flex items-center gap-2 hover:gap-4 transition-all">View Specs <ChevronRight className="w-4 h-4"/></button>
               </div>
               
               <div className="border border-[#3C5929]/30 p-8 rounded-xl bg-gradient-to-b from-[#3C5929]/5 to-[#05080D] flex flex-col relative transform md:-translate-y-4">
                 ...
                 <span className="text-[#3C5929] text-xs font-bold uppercase tracking-[2px] mb-4">Tier 2</span>
           ...
           <div className="flex flex-wrap gap-2 mb-8 border-b border-white/10 pb-4">
             {['Sensor Matrix', 'Tracking Ranges', 'Physical & Environmental'].map((tab, idx) => (
               <button 
                 ...
                 className={`px-6 py-2 text-sm font-medium transition-colors rounded-t-md ${activeSpecTab === idx ? 'text-[#3C5929] border-b-2 border-[#3C5929]' : 'text-white/50 hover:text-white'}`}
               >
                 {tab}
               </button>
             ))}
            ...
            <div className="w-full md:w-1/3 flex flex-col gap-2">
              {[
                ...
                <button 
                  ...
                  className={`flex items-center gap-4 p-6 rounded-lg border transition-all text-left ${activeScenarioTab === idx ? 'bg-[#3C5929]/10 border-[#3C5929]/50 text-white' : 'bg-[#05080D] border-white/10 text-white/50 hover:bg-white/5'}`}
                >
                  <role.icon className={`w-6 h-6 ${activeScenarioTab === idx ? 'text-[#3C5929]' : ''}`} />
      ...
      <section className="w-full py-40 px-6 bg-[#3C5929] text-black text-center">
        <div className="max-w-[1000px] mx-auto gsap-fade-up">
