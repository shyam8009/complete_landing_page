...
import img1 from '@/imports/big-data/data_warehouse_modernization.jpg';
import img2 from '@/imports/big-data/operational_efficiency.png';
import img3 from '@/imports/big-data/strategic_consultation.png';
