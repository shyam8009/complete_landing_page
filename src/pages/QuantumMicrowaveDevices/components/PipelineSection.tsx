...
const PIPELINE_STEPS = [
  {
    ...
    title: "AMPLIFY",
    icon: Network,
    description: "Travelling Wave Parametric Amplifiers add close to the minimum noise physics permits, holding a faint signal intact through the first and most decisive stage of gain."
  },
  {
    id: "02",
    title: "CONDITION",
    icon: Activity,
    description: "HEMT amplifiers, IQ mixers, filters and attenuators shape the chain from first stage through to the end."
  },
  {
    id: "03",
    title: "COOL",
    icon: Crosshair,
    description: "Cryogenic RF and microwave design, engineered for the thermal conditions quantum hardware demands."
  },
  {
    id: "04",
    title: "SUPPLY",
    icon: Cpu,
    description: "Component-level hardware for quantum, research and defence programmes building systems of their own."
  }
];
