...
export default function AboutManifesto() {
  ...
  return (
    <section ref={containerRef} className="relative w-full bg-[#050505] text-white py-16 md:py-20 z-10">
      <div className="max-w-[1400px] w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-8">
        ...
        {/* Intro & Vision Grid */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24 mb-8 border-t border-white/10 pt-12">
