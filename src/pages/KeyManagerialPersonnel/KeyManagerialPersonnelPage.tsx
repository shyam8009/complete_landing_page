...
const PERSONNEL = [
  { name: "Mr. Pratik Ramjibhai Kakadiya", designation: "Managing Director & Chairman" },
  { name: "Ms. Hetal Pratikbhai Kakadiya", designation: "Director" },
  { name: "Mr. Jatinkumar Dhirajlal Jogani", designation: "Chief Financial Officer" },
  { name: "Mr. Shrikant Rashmikanth Khatri", designation: "Company Secretary & Compliance Officer" },
];

const STATS = [
  { value: "4", label: "Key Executives" },
  { value: "100%", label: "Alignment" },
  { value: "2025", label: "Active Board" },
];
        ...
        >
          ...
          >
            ...
            <span className="text-[11px] font-bold tracking-[2.5px] text-[#84CC16] uppercase">
              INVESTOR RELATIONS / KEY MANAGERIAL PERSONNEL
            </span>
          </motion.div>
          ...
          >
            Executive leadership driving Sahana Defence's strategic vision and ensuring effective governance.
          </motion.p>
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-6 sm:px-10">
        ...
        >
          {PERSONNEL.map((person, i) => (
            <PersonnelCard key={person.name} name={person.name} designation={person.designation} index={i} />
          ))}
        </motion.div>
      </div>
    </section>
