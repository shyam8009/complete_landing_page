          ...
          {VALUES.map((val, i) => {
            ...
            return (
              <div
                ...
                className={ + '' + elative flex flex-col border-b md:border-b-0 md:border-r border-white/20 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]   + '' + }
              >
...
'''
with codecs.open('src/pages/AboutUs/components/AboutValues.tsx', 'w', 'utf-8') as f:
    f.write(content)
